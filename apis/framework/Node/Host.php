...
class TeamSpeak3_Node_Host extends TeamSpeak3_Node_Abstract
{
    ...
    public function serverGetPortById($sid)
    {
        ...
        return $this->serverList[(int) ((string) $sid)]['virtualserver_port'];
    }
    ...
    public function serverGetById($sid)
    {
        ...
        return new TeamSpeak3_Node_Server($this, ['virtualserver_id' => (int) $sid]);
    }
    ...
    public function serverCreate(array $properties = [])
    {
        ...
        $server = new TeamSpeak3_Node_Server($this, ['virtualserver_id' => (int) ($detail['sid'])]);
